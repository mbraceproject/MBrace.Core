...
type internal Trampoline private () =
    ...
    static let bindThreshold = if isTailCallOptimizingRuntime then 1000 else 300
    ...
    static member IsBindThresholdReached () = threadInstance.Value.IsBindThresholdReached()
