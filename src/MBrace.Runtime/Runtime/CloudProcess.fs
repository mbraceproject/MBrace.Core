...
type CloudProcess internal () =
    ...
    abstract AwaitResultBoxed : [<O;D(null:obj)>]?timeoutMilliseconds:int -> Async<obj>
    ...
    abstract GetLogsAsync : [<O;D(null:obj)>]?filter:(CloudLogEntry -> bool) -> Async<CloudLogEntry []>

    /// <summary>
    ///     Asynchronously fetches log all log entries generated by given cloud process.  
    /// </summary>
    /// <param name="filter">User-specified log entry filtering function.</param>
    member __.GetLogs([<O;D(null:obj)>]?filter: CloudLogEntry -> bool) = __.GetLogsAsync(?filter = filter) |> Async.RunSync

    /// <summary>
    ///     Asynchronously fetches log all log entries generated by given cloud process.  
    /// </summary>
    /// <param name="filter">User-specified log entry filtering function.</param>
    abstract ShowLogs : [<O;D(null:obj)>]?filter:(CloudLogEntry -> bool) -> unit
...
and [<Sealed; DataContract; NoEquality; NoComparison>] CloudProcess<'T> internal (source : ICloudProcessEntry, runtime : IRuntimeManager) =
    ...
    /// </summary>
    /// <param name="timeoutMilliseconds">Timeout in milliseconds. Defaults to infinite timeout.</param>
    member __.AwaitResult ([<O;D(null:obj)>]?timeoutMilliseconds:int) : Async<'T> = async {
