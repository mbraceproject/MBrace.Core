...
type WorkerRef private (runtime : IRuntimeManager, workerId : IWorkerId) =
    ...
    member __.GetSystemLogsAsync() = runtime.RuntimeSystemLogManager.GetWorkerLogs(workerId)
    /// Fetches all system logs generated by worker instance
    member __.GetSystemLogs() = runtime.RuntimeSystemLogManager.GetWorkerLogs(workerId) |> Async.RunSync
