...
namespace MBrace.Streams.CSharp
{
    ...
    public static class CloudStream
    {
        ...
        public static CloudStream<TSource> WithDegreeOfParallelism<TSource>(this CloudStream<TSource> stream, int degreeOfParallelism)
        {
            return CloudStreamModule.withDegreeOfParallelism(degreeOfParallelism, stream);
        }
